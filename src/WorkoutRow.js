  ...
  render() {
    return this.state.editing ? (
      <tr className="WorkoutRow" key={this.state.workout.id}>
        <td>
          <ButtonGroup justified>
            ...
            <ButtonGroup>
              <Button
                bsStyle="primary"
                disabled={!this.state.editor.valid || this.state.saving}
                onClick={() => this.update()}
              >
                {this.state.saving ? (
                  <span>
                    <i class="fa fa-pulse fa-spinner fa-fw" />Saving
                  </span>
                ) : (
                  <span>Save</span>
                )}
        ...
        <td>
          <FormGroup controlId="lbs">
            <FormControl
              componentClass="select"
              value={this.state.editor.fields.lbs.value}
              onChange={e => {
                this.change('lbs', 'string', e);
              }}
            >
          ...
          <ButtonGroup justified>
            ...
            <ButtonGroup>
              ...
              >
                {this.state.deleting ? (
                  <span>
                    <i class="fa fa-pulse fa-spinner fa-fw" /> Deleting...
                  </span>
                ) : (
                  <span>Delete</span>
                )}
